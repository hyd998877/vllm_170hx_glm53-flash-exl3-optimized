...
def get_quant_config(
    ...
    # If no checkpoint or online config was found, try to get a config from
    # hf_overrides. Callable overrides are valid for draft models (for example
    # DFlash/EAGLE inherits a target config transform), but only dictionary
    # overrides can carry a quantization config file.
