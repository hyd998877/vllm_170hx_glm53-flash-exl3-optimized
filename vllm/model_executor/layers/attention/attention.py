...
class Attention(nn.Module, AttentionLayerBase):
    ...
    def __init__(
        ...
        **extra_impl_args,
        ...
        # DFlash uses a block-anchored non-causal sliding window: one shared
        # historical tail plus the complete current draft block. This is
        # distinct from the generic query-centred encoder window.
        self.dflash_block_attention = dflash_block_attention
