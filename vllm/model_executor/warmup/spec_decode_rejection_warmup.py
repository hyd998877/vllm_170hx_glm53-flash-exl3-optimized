    ...
    for tgt_dtype, draft_dtype in warmup_dtype_pairs:
        ...
        try:
            rejection_sample(
                ...
                # InputBatch request mappings are int64 in serving. Triton
                # specializes pointer element types, so warm them with the
                # same dtype instead of creating unreachable int32 entries.
