...
def test_prefix_cache_opt_out_group_does_not_disable_partial_hash_hits():
    """Per-request scratch groups do not constrain prefix-cache lookup."""
    hash_block_size = 2
    ...
    assert not kv_cache_config.kv_cache_groups[2].kv_cache_spec.participates_in_prefix_caching
